...
public class Variables {
	...
	static String name = "Tanzu";				//Static variable - variables belong to class and don't required creating object
	...
	public static void main(String[] args) {
		...
		//	class_name object_name = new_name();
